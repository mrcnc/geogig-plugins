...
import com.boundlessgeo.geogig.osm.internal.MappingRule.DefaultField;
import com.boundlessgeo.geogig.osm.internal.log.OSMMappingLogEntry;
import com.boundlessgeo.geogig.osm.internal.log.ReadOSMMapping;
import com.boundlessgeo.geogig.osm.internal.log.ReadOSMMappingLogEntry;
...
public class OSMUnmapOp extends AbstractGeoGigOp<RevTree> {
    ...
    protected RevTree _call() {
        ...
        FeatureMapFlusher flusher = new FeatureMapFlusher(repository());
        while (iter.hasNext()) {
